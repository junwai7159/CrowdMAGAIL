...
from utils.preprocess import trajectories_split
import os
...
def get_args():
    ...
    parser.add_argument('-i', '--input', type=str, default='./data/cache/GC/',
                        help='output file path')
    parser.add_argument('-o', '--output', type=str, default='./data/GC/',
                        help='output file path')
...
if __name__ == '__main__':
    ...
    # import cv2
    image = cv2.imread('./data/cache/GC/gc_reference.jpg')
    # post1 = np.float32([[456, 118], [1441, 120],[64, 919],[1914, 939] ])
    post1 = np.float32([[185, 774], [1734, 774], [460, 172], [1429, 179]])
    post2 = np.float32([[0, length],[width, length], [0, 0], [width, 0]])
